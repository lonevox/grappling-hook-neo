package com.lonevox.grapplinghookneo.entities.grapplehook;
...
public class RenderGrapplehookEntity<T extends GrapplehookEntity> extends EntityRenderer<T>
{
    ...
    private static final ResourceLocation HOOK_TEXTURES = ResourceLocation.fromNamespaceAndPath("grappling_hook_neo", "textures/entity/entity_hook.png");
    private static final RenderType HOOK_RENDER = RenderType.entityCutoutNoCull(HOOK_TEXTURES, false);
    private static final ResourceLocation ROPE_TEXTURES = ResourceLocation.fromNamespaceAndPath("grappling_hook_neo", "textures/entity/rope.png");
...
//        			taut = hookEntity.taut;
        ...
        for (int size = 0; size < 4; size++) {
        	...
        	vertexbuffer.addVertex(matrix4f1, (float) cornerpos.x, (float) cornerpos.y, (float) cornerpos.z)
					.setColor(255, 255, 255, 255)
					.setUv(uvs[size][0], uvs[size][1])
					.setOverlay(OverlayTexture.NO_OVERLAY)
					.setLight(p_225623_6_)
    ...
    public void drawSegment(Vec start, Vec finish, double taut, VertexConsumer vertexbuffer, Matrix4f matrix, int p_225623_6_) {
        ...
        for (int size = 0; size < 4; size++) {
            ...
            for (int square_num = 0; square_num < number_squares; square_num++)
            {
                ...
                vertexbuffer.addVertex(matrix, (float) corner1pos1.x, (float) corner1pos1.y, (float) corner1pos1.z)
						.setColor(255, 255, 255, 255)
						.setUv(0, squarefrac1)
						.setOverlay(OverlayTexture.NO_OVERLAY)
						.setLight(p_225623_6_)
						.setNormal((float) normal1.x, (float) normal1.y, (float) normal1.z);
                vertexbuffer.addVertex(matrix, (float) corner2pos1.x, (float) corner2pos1.y, (float) corner2pos1.z)
						.setColor(255, 255, 255, 255)
						.setUv(1, squarefrac1)
						.setOverlay(OverlayTexture.NO_OVERLAY)
						.setLight(p_225623_6_)
						.setNormal((float) normal2.x, (float) normal2.y, (float) normal2.z);
                vertexbuffer.addVertex(matrix, (float) corner2pos2.x, (float) corner2pos2.y, (float) corner2pos2.z)
						.setColor(255, 255, 255, 255)
						.setUv(1, squarefrac2)
						.setOverlay(OverlayTexture.NO_OVERLAY)
						.setLight(p_225623_6_)
						.setNormal((float) normal2.x, (float) normal2.y, (float) normal2.z);
                vertexbuffer.addVertex(matrix, (float) corner1pos2.x, (float) corner1pos2.y, (float) corner1pos2.z)
						.setColor(255, 255, 255, 255)
						.setUv(0, squarefrac2)
						.setOverlay(OverlayTexture.NO_OVERLAY)
						.setLight(p_225623_6_)
