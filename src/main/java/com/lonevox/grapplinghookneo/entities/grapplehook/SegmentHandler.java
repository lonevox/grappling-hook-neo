...
public class SegmentHandler {
	...
	public void removeSegment(int index) {
		...
		if (!this.world.isClientSide) {
			...
			ChunkPos chunkPos = world.getChunkAt(BlockPos.containing(playerpoint.x, playerpoint.y, playerpoint.z)).getPos();
			NetworkSetup.sendToTrackingChunk((ServerLevel) world, chunkPos, addmessage);
		}
	}
