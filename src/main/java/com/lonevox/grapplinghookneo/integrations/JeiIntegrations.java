...
public class JeiIntegrations implements IModPlugin {
	...
	public ResourceLocation getPluginUid() {
		return ResourceLocation.fromNamespaceAndPath("grappling_hook_neo", "jeiintegration");
	}
	...
	ResourceLocation modifierRecipesLoc = ResourceLocation.fromNamespaceAndPath("grappling_hook_neo", "modifierrecipes");
	...
	public void registerCategories(IRecipeCategoryRegistration registration) {
		...
		registration.addRecipeCategories(new IRecipeCategory<ModifierRecipes>() {
			...
			public String getTitle() {
				return ClientProxyInterface.proxy.localize("block.grappling_hook_neo.block_grapple_modifier");
			}

			@Override
			public IDrawable getBackground() {
				return registration.getJeiHelpers().getGuiHelper().createDrawable(ResourceLocation.fromNamespaceAndPath("grappling_hook_neo", "textures/gui/jei_modifier_bg.png"), 0, 0, 120, 60);
			}
			...
			public void draw(ModifierRecipes recipe, PoseStack matrixStack, double mouseX, double mouseY) {
				...
				if (recipe.input2 != null) {
					String text = ClientProxyInterface.proxy.localize("grappling_hook_neo.jei_modifier_text");
					int linenum = 0;
